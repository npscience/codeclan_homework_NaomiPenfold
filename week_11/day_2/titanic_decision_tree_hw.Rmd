...
can stratify not just to balance the outcome % but also to balance the potential key predictors, e.g. class, age, etc - this is important for getting good spec and sens
