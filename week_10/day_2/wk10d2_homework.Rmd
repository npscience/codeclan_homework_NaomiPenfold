...
To set a reference programmatically (instead of R picking the alphabetically first one), make the <chr> a factor <fctr> type and relevel - second argument is ref = so can specify your factor 1 value here.

Example (with grades df from wk10d2):
